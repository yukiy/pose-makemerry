...
PxGraphicEffects.prototype.create = function(px)
{
...
PxGraphicEffects.prototype.clear = function()
{
	this.graphics.clear();
}

PxGraphicEffects.prototype.init = function()
{
	this.graphics.clear();
	this.traceLinePoints = [];
	this.traceCirclePoints = [];
...
PxGraphicEffects.prototype.drawBones = function(keypoints, lineWidth)
{
	let col = 0x000000;
...
PxGraphicEffects.prototype.drawLine = function(keypoints, partsId1, partsId2, col, lineWidth)
{
...
PxGraphicEffects.prototype.drawTraceLine = function(keypoints, partsId, options)
{
	if (keypoints.length > 0)
	{
		const p = partsId*3;
...
PxGraphicEffects.prototype.drawTraceCircle = function(keypoints, partsId, options)
{
	if (keypoints.length > 0)
	{
		const p = partsId*3;
...
PxGraphicEffects.prototype.drawCircle = function(x, y, r, options)
{
